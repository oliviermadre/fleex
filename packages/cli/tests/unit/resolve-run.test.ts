...
import {
  ...
  resolveStepRunId,
  type RunDetail,
} from '../../src/commands/workflow/_shared.ts';
...
const RUNS = [
  {
    ...
    status: 'running',
    templateSnapshot: { name: 'alpha' },
  },
  {
    id: 'aaaaaaaa-9999-8888-7777-666666666666',
    status: 'done',
    templateSnapshot: { name: 'alpha-2' },
  },
  {
    id: 'bbbbbbbb-1111-2222-3333-444444444444',
    status: 'running',
    templateSnapshot: { name: 'beta' },
  },
];
...
describe('resolveStepRunId', () => {
  ...
  it('resolves a full step-run UUID', () => {
    expect(resolveStepRunId(DETAIL, 'dddddddd-1111-2222-3333-444444444444')).toBe(
