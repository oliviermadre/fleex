...
export function buildFixture() {
  ...
  const tickets = [
    ...
    ticket({
      ...
      statusChangedAt: '2026-06-01T11:00:00.000Z',
      links: [prLink('p1', '2026-06-01T10:30:00.000Z')],
    }),
    ticket({
      id: T.doing,
      boardId: BOARD_FRONTEND,
      displayId: 3,
      title: 'Doing item',
      status: 'doing',
      createdAt: '2026-06-02T08:00:00.000Z',
      statusChangedAt: '2026-06-02T18:00:00.000Z',
    }),
    ticket({
      id: T.reviewing,
      boardId: BOARD_FRONTEND,
      ...
      statusChangedAt: '2026-06-04T08:00:00.000Z',
      links: [
        prLink('p2', '2026-06-03T10:00:00.000Z'),
        issueLink('i1', '2026-06-03T10:00:00.000Z'),
      ],
    }),
    ticket({
      id: T.doneWithMoves,
      ...
      statusChangedAt: '2026-06-04T10:00:00.000Z',
      links: [prLink('p3', '2026-06-02T10:00:00.000Z')],
    }),
    ticket({
      id: T.doneNoMoves,
      boardId: BOARD_OPS,
      ...
      statusChangedAt: '2026-06-05T09:00:00.000Z',
    }),
    ticket({
      id: T.cancelled,
      boardId: BOARD_OPS,
      ...
      statusChangedAt: '2026-06-06T09:00:00.000Z',
    }),
    ticket({
      id: T.doneUnknownBoard,
      boardId: BOARD_DELETED,
      displayId: 8,
      title: 'Done on deleted board',
      status: 'done',
      createdAt: '2026-06-01T07:00:00.000Z',
      statusChangedAt: '2026-06-03T15:00:00.000Z',
      links: [prLink('p4', '2026-06-02T10:00:00.000Z')],
    }),
    ticket({
      id: T.createdBeforeRange,
      boardId: BOARD_BACKEND,
      displayId: 9,
      title: 'Old ticket completed in range',
      status: 'done',
      createdAt: '2026-05-20T08:00:00.000Z',
      statusChangedAt: '2026-06-02T11:00:00.000Z',
      links: [prLink('p5', '2026-05-21T10:00:00.000Z')],
    }),
    ticket({
      id: T.createdAfterRange,
      boardId: BOARD_BACKEND,
      displayId: 10,
      title: 'Future ticket',
      status: 'todo',
      createdAt: '2026-06-10T08:00:00.000Z',
      statusChangedAt: '2026-06-10T08:00:00.000Z',
    }),
  ];
  ...
  const executions: AgentExecution[] = [
    // No `source` → read as sdk. Has cost + tokens.
    {
      ...
      completedAt: '2026-06-01T09:35:00.000Z',
      lastEventAt: null,
      costUsd: 0.5,
      inputTokens: 100,
      outputTokens: 50,
    ...
    // Manual CLI session — no tokens recorded.
    {
      ...
      completedAt: '2026-06-03T14:45:00.000Z',
      lastEventAt: null,
      costUsd: 3,
      source: 'cli',
    },
    // Skill run, still open (no completedAt) and failed → excluded from durations.
    {
      id: 'x4',
      personaId: 'p-scout',
      ticketId: T.reviewing,
      mentionId: 'skill:sk-spec',
      eventCount: 1,
      status: 'failed',
    ...
    // Skill run on a known skill.
    {
      ...
      completedAt: '2026-06-05T11:02:00.000Z',
      lastEventAt: null,
      costUsd: 0.1,
      inputTokens: 10,
      outputTokens: 5,
    ...
    // Skill run on an unknown skill id → falls back to the raw id.
    {
      ...
      personaId: 'p-builder',
      ticketId: T.reviewing,
      mentionId: 'skill:sk-ghost',
      eventCount: 1,
      status: 'completed',
      startedAt: '2026-06-06T20:00:00.000Z',
      completedAt: '2026-06-06T20:10:00.000Z',
      lastEventAt: null,
      costUsd: 0.2,
    },
    ...
    // Outside the window.
    {
      ...
      completedAt: '2026-05-30T09:10:00.000Z',
      lastEventAt: null,
      costUsd: 9,
    },
  ];
  ...
  const panelEvents = [
    ...
    logEntry(
      'panel.executed',
      { panelId: 'pan2', status: 'completed', durationMs: 1000, respondedMembers: 1 },
      '2026-06-05T15:00:00.000Z',
    ),
    // No panelId at all → grouped under "unknown"; the name lookup finds nothing.
    logEntry(
      'panel.executed',
      { status: 'completed', durationMs: 2000, respondedMembers: 4 },
