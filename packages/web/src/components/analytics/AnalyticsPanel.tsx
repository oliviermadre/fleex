...
export function AnalyticsPanel() {
  ...
  return (
    <div className="flex min-w-0 flex-1 flex-col overflow-hidden bg-[var(--theme-bg-primary)]">
      {/* Breadcrumb header */}
      <div className="flex items-center gap-2 border-b border-[var(--theme-border)] px-6" style={{ height: 'var(--header-height)' }}>
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-[var(--theme-text-muted)]">
