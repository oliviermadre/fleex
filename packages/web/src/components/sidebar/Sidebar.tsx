...
export function Sidebar() {
  ...
  return (
    <div className="flex h-full flex-col border-r border-zinc-800 bg-zinc-900/50">
      ...
      <SessionGroups />
      <button
        className="flex items-center gap-2 border-t border-zinc-800/50 px-3 py-2 text-xs text-zinc-500 transition-colors hover:bg-zinc-800/50 hover:text-zinc-300"
