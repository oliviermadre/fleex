...
export function BoardSelectorDropdown() {
  ...
  const totalCount = (Object.values(columns) as import('@fleex/shared').Ticket[][]).reduce(
  ...
  return (
    <>
      ...
      <div className="flex items-center gap-1">
        ...
        {selectedBoard && <BoardActionsDropdown board={selectedBoard} />}
        ...
        {open && (
          <FloatingPortal>
            ...
            >
                ...
                <>
                  ...
                  >
                    ...
                    <span className="text-xs text-[var(--theme-text-muted)]">
                      {(
                        Object.values(ticketsByColumn(null)) as import('@fleex/shared').Ticket[][]
              ...
              {boards.map((b) => {
                const count = (
                  Object.values(ticketsByColumn(b.id)) as import('@fleex/shared').Ticket[][]
