  ...
  return createPortal(
    <div style={{ position: 'fixed', inset: 0, zIndex: 55, pointerEvents: 'none' }}>
      ...
      >
        ...
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--theme-accent)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
          ...
          {showTerminate && (
            <button
              ...
              style={{
                ...
                background: terminateState === EXECUTION_STATES.CONFIRMING ? 'var(--theme-danger)' : 'rgba(255, 80, 80, 0.15)',
                color: terminateState === EXECUTION_STATES.CONFIRMING ? '#fff' : 'var(--theme-danger)',
