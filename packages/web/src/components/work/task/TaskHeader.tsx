/**
 * Task header (center, 44px): title, mono #num, and the shell / mode / overflow
 * controls. The shell drawer and shell mode land in Phase 2, so their buttons
 * are present but disabled with a hint; the overflow menu links back to the
 * ticket's Kanban and Sessions homes.
 */
    ...
    <div className="flex h-11 shrink-0 items-center gap-2 border-b border-[var(--theme-border)] px-4">
      ...
      <div className="ml-auto flex items-center gap-1">
        <button
          type="button"
          disabled
          title="Shell drawer — Phase 2"
          className="flex items-center gap-1 rounded-md px-2 py-1 text-[12px] text-[var(--theme-text-faint)] opacity-60"
        >
