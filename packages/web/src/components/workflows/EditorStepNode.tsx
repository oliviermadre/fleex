    ...
    >
      ...
      <div
        ...
        style={{
          ...
          // Dashed for the step types that run no work of their own.
          border: `2px ${step.executorType === 'human_gate' || step.executorType === 'route' || step.executorType === 'trigger' ? 'dashed' : 'solid'} ${borderColor}`,
          color: borderColor,
          cursor: 'pointer',
