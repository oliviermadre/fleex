    ...
    <div className="flex flex-col h-full w-full" style={{ color: 'var(--theme-text-primary)' }}>
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={() =>
              reactFlow.fitView({ padding: 0.3, minZoom: 0.3, maxZoom: 1.2, duration: 300 })
            }
            className="text-xs px-3 py-1 rounded border"
            style={{ borderColor: 'var(--theme-border)', color: 'var(--theme-text-primary)' }}
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div ref={wrapperRef} className="flex-1" onDrop={onDrop} onDragOver={onDragOver}>
          ...
          >
            ...
            <Controls
              className="!bg-[var(--theme-bg-surface)] !border-[var(--theme-border)]"
        ...
        <div
          className="w-[320px] border-l p-4 overflow-y-auto"
          style={{ borderColor: 'var(--theme-border)' }}
        >
          {selectedStep ? (
            <StepConfigPanel
