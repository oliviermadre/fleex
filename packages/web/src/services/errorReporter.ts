 ...
 */
function fingerprint(message: string, stack: string | undefined, boundary: string | undefined): string {
...
function send(report: ClientErrorReport): void {
  ...
  if (typeof document !== 'undefined' && document.visibilityState === 'hidden' && typeof navigator.sendBeacon === 'function') {
