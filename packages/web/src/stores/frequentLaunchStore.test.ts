...
import { buildFrequentItems, buildMostUsedItems, type FrequentSource } from './frequentLaunchStore';
...
const source: FrequentSource = {
  ...
  templates: [{ id: 'wf1', name: 'PR Review', slug: 'pr-review', emoji: '🚦' }],
  panels: [{ id: 'pn1', displayName: 'Archi Committee', name: 'archi-committee' }],
  personas: [
